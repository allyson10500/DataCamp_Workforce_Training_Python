...
# Add a layer of your prediction points
sns.scatterplot(data = prediction_data, y="qdrt_n_clicks", x="qdrt_n_impressions", color="red")
plt.show()
...
sns.residplot(x="n_convenience",
                y="price_twd_msq", data=taiwan_real_estate, lowess = True)
...
plt.show()# Redraw the plot with time_since_first_purchase
