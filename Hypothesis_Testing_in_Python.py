...
unpaired_test_results = pingouin.ttest(x=sample_dem_data['diff'], y=0,alternative="two-sided")
...
expected, observed, stats = pingouin.chi2_independence(data=late_shipments, y="freight_cost_group" , x="vendor_inco_term")
